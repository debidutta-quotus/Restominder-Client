      ...
      <div className="auth-signup-page-form-container">
        <div className="auth-signup-page-form-section">
          ...
          <form onSubmit={handleSubmit}>
            <div className="auth-signup-page-form-group">
              ...
              <div className="auth-signup-page-input-container">
                <input
                  ...
                  required
                />
                <button type="button" className="auth-signup-page-clear-button" onClick={() => setName('')}>
            ...
            <div className="auth-signup-page-form-group">
              ...
              <div className="auth-signup-page-input-container">
                <input
                  ...
                  required
                />
                <button type="button" className="auth-signup-page-clear-button" onClick={() => setEmail('')}>
            ...
            <button type="submit" className="auth-signup-page-signup-button">Sign Up</button>
          </form>
          ...
          <div className="auth-signup-page-login-prompt" onClick={handleLoginClicked}>
            <p>Have an account? <a href="#" className="auth-signup-page-login-link">Login</a></p>
          </div>
        </div>
